...
свободное время играю в видеоигры и зарабатываю в них.
          ...
          <div className='student__media'>
            <a className='student__media-item student__text' href='https://github.com/Pokhvalenskii'>Github</a>
            <a className='student__media-item student__text' href='https://t.me/pokhvalenskii'>Telegram</a>
          </div>
        </div>
      ...
      <div className='portfolio'>
        ...
        <a className='portfolio__link' href='URL'>
